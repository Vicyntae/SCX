ScriptName SCVSwallowSpell Extends ActiveMagicEffect
Int DMID = 9
...
String Property VoreType = "Oral" Auto
...
;SCX_BasePerk Property SCLAllowOverflow Auto

SCX_BasePerk Property SCV_FriendlyFood Auto

SCX_BasePerk Property SCV_ExpectPushback Auto

SCX_BasePerk Property SCV_StrokeOfLuck Auto
SCX_BasePerk Property SCV_IntenseHunger Auto
...
Event OnEffectStart(Actor akTarget, Actor akCaster)
  ...
  If Setting_RunAnim
    String Situation
    If Pred.IsSneaking() && !Pred.IsDetectedBy(Prey) && SCV_Stalker.getPerkLevel(Pred) >= 1
      Situation = "Stealth"
...
Bool Function checkSpecificConditions()
  ...
  Float DigestValue = SCVLib.genDigestValue(Prey, True) ;Can we calculate this later and perform a fail animation instead?
...
Function runVore()
  ...
  If !Pred.IsInCombat() || !Prey.IsInCombat()
