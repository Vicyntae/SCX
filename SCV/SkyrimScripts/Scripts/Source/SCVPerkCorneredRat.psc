ScriptName SCVPerkCorneredRat Extends SCX_BasePerk
...
Bool Function canTake(Actor akTarget, Int aiPerkLevel, Bool abOverride, Int aiTargetData = 0)
  ...
  If aiPerkLevel == 1 && JMap.getInt(TargetData, "SCV_NumTimesEaten") >= 1 && MQ202.IsCompleted()  ;Complete A Cornered Rat
    Return True
  ElseIf aiPerkLevel == 2 && JMap.getInt(TargetData, "SCV_NumTimesEaten") >= 5 && MG08.IsCompleted() ;Complete The Eye of Magnus
    Return True
  ElseIf aiPerkLevel == 3 && JMap.getInt(TargetData, "SCV_NumTimesEaten") >= 15 && MQ301.IsCompleted() ; Complete The Fallen
    Return True
  EndIf
EndFunction
