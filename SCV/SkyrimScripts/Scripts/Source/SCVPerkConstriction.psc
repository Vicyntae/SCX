ScriptName SCVPerkConstriction Extends SCX_BasePerk
...
Bool Function canTake(Actor akTarget, Int aiPerkLevel, Bool abOverride, Int aiTargetData = 0)
  ...
  If aiPerkLevel == 1 && ArmorLevel >= 20 && Stamina >= 200 && dunTrevasWatchQST.IsCompleted() ;Complete Infiltration
    Return True
  ElseIf aiPerkLevel == 2 && ArmorLevel >= 40 && Stamina >= 300 && dunIronbindQST.IsCompleted()  ;Complete Coming of Age at Ironbind Barrow
    Return True
  ElseIf aiPerkLevel == 3 && ArmorLevel >= 60 && Stamina >= 400 && dunMistwatchQST.IsCompleted()
    Return True
  EndIf
EndFunction
