...
Function addMCMActorInformation(SCX_ModConfigMenu MCM, Int JI_Options, Actor akTarget, Int aiTargetData = 0)
  ...
  JIntMap.setStr(JI_Options, MCM.AddTextOption("$SCXMCMTotalWeightContained", getActorTotalWeightContained(akTarget, aiTargetData)), "Stats.SCX_Library.SCXShowTotalContained")
  JIntMap.setStr(JI_Options, MCM.AddTextOption("$SCXMCMTotalWeightOverall", genWeightValue(akTarget)), "Stats.SCX_Library.SCXShowTotalOverrall")
EndFunction
...
Function setSelectOptions(SCX_ModConfigMenu MCM, String asValue, Int aiOption)
  If asValue == "SCXShowTotalContained"
    MCM.ShowMessage("$SCXMCMTotalContainedInfo", False, "OK", "")
  ElseIf asValue == "SCXShowTotalOverrall"
    MCM.ShowMessage("$SCXMCMTotalOverallInfo", False, "OK", "")
  EndIf
EndFunction

Function setHighlight(SCX_ModConfigMenu MCM, String asValue, Int aiOption)
  If asValue == "SCXShowTotalContained"
    MCM.setInfoText("$SCXMCMTotalContainedInfo")
  ElseIf asValue == "SCXShowTotalOverrall"
    MCM.setInfoText("$SCXMCMTotalOverallInfo")
  EndIf
EndFunction
