ScriptName SCX_TransferContainer Extends ObjectReference
Int DMID = 4
String Property DebugName
  String Function Get()
    Return "[SCX_Transfer " + Target.GetLeveledActorBase().GetName() + "] "
  EndFunction
EndProperty
...
Event OnMenuClose(string menuName)
  ...
  Chest.TransferArchetype = Archetype
  Chest.TransferTarget = Target
  Chest.akReturn = PlayerRef
  RemoveAllItems(Chest, True, True)
...
Event OnItemAdded(Form akBaseItem, int aiItemCount, ObjectReference akItemReference, ObjectReference akSourceContainer)
  UpdateLock()
  If ArchetypeForm
    If ArchetypeForm.checkTransferItem(Target, akItemReference, akBaseItem, aiItemCount)
      ArchetypeForm.displayTransferItemAccept(Target, akItemReference, akBaseItem, aiItemCount)
    Else
      ArchetypeForm.displayTransferItemReject(Target, akItemReference, akBaseItem, aiItemCount)
      If akItemReference
